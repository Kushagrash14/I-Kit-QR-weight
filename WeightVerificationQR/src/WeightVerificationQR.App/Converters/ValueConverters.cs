...
/// <summary>Returns true when the bound value's string form equals the converter parameter (used for nav active state).</summary>
...
/// <summary>Converts an empty/whitespace string to Collapsed (unlike NullToVisibilityConverter which only checks null).</summary>
